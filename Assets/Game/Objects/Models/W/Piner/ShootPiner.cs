...
using UnityEngine;
public class ShootPiner : MonoBehaviour
{
    public GameObject weapon;
    public GameObject projectile;
    private float rate_of_fire = 4f;
    private float time_of_fire = 4f;
    private float power_fire = 150f; // Не путать с уроном от выстрела
  //[SerializeField] private float destroyTimeout = 100;
  //private float _timerDelete;
    ...
    private void Fire()
    {
      ...
      //if (_timerDelete >= destroyTimeout) Destroy(projectile_fire);
    }
}
